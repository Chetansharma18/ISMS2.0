          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center max-w-5xl mx-auto relative z-10">
            ...
            <div class="lg:col-span-7 flex flex-col justify-center">
              ...
              <div class="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-5">
                <!-- Feature 1 -->
                <div class="bg-white rounded-2xl sm:rounded-full w-[98px] h-[98px] sm:w-[124px] sm:h-[124px] border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center p-2 shrink-0 transition-all duration-300 hover:shadow-lg hover:-translate-y-1.5 hover:border-blue-200 cursor-pointer group">
              ...
              <div class="mt-6 sm:mt-8 grid grid-cols-3 items-center divide-x divide-slate-300 bg-white/80 p-4 sm:p-5 rounded-2xl shadow-2xs border border-transparent transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 hover:bg-white hover:border-blue-200 cursor-pointer w-full max-w-md mx-auto lg:mx-0">
