        ...
        <div class="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          @if (currentUser()) {
            <div class="relative" id="user-menu-container">
              ...
              @if (dropdownOpen()) {
                <div
                  class="absolute right-0 top-full mt-2 w-48 bg-white border border-slate-200 rounded-xl shadow-xl z-[60] overflow-hidden py-1"
                  role="menu"
                >
...
export class HeaderComponent {
  ...
  readonly displayName = computed(() => {
    ...
    if (!u) return '';
    return (u as any).label || (u as any).ssoId || (u as any).username || (u as any).id || 'User';
  });
