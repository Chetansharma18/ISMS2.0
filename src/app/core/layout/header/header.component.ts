        ...
        <div class="flex items-center gap-1.5 sm:gap-3.5 shrink-0">
          ...
          @if (currentUser()) {
            <div class="relative" id="user-menu-container">
              ...
              >
                <!-- Avatar Icon -->
                <div class="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#174A6E] text-white flex items-center justify-center font-bold text-[11px] sm:text-xs uppercase shadow-2xs shrink-0 select-none">
                  {{ avatarChar() }}
                </div>
