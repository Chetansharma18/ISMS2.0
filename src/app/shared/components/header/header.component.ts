            ...
            <div 
              *ngIf="userMenuOpen()" 
              ...
              <a 
                routerLink="/profile"
                (click)="closeUserMenu()"
                class="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-bold text-slate-700 hover:bg-slate-100 hover:text-[#002244] rounded-md transition text-left cursor-pointer">
