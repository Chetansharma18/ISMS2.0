    ...
    <footer #footerRef class="w-full bg-[#12223a] text-slate-300 font-sans border-t border-slate-700 select-none">
      ...
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <div class="flex items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <h3 class="text-lg sm:text-2xl font-bold text-white tracking-wide text-center">Other Important Links</h3>
      ...
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 lg:gap-8 items-start">
          ...
          <div class="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <h2 class="text-2xl sm:text-3xl font-black text-white mb-1 tracking-tight">ISMS <span class="text-[#F59E0B]">2.0</span></h2>
            <p class="text-xs sm:text-sm font-semibold text-white mb-1">Integrated Scheme Management System</p>
          ...
          <div class="flex flex-col items-center text-center">
            <div class="w-full flex flex-col items-center">
              ...
              <div class="flex flex-wrap justify-center items-center gap-2 sm:gap-4 text-xs sm:text-[13px] text-slate-300 font-bold pt-4 border-t border-slate-700/50 w-full mt-auto">
                <div class="flex items-center gap-1.5">
                  <span>Total Visitors:</span>
                  <span class="text-white font-mono">042,159</span>
                </div>
          ...
          <div class="flex flex-col items-center md:items-end text-center md:text-right">
            <div>
              <h4 class="text-sm font-bold text-white mb-3">Connect With Us</h4>
              <div class="flex items-center justify-center md:justify-end gap-3 mb-6">
                <a [href]="helplineGlobal.social.facebook" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#12223a] hover:bg-slate-200 transition-colors" aria-label="Facebook">
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
                </a>
                <a [href]="helplineGlobal.social.twitter" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#12223a] hover:bg-slate-200 transition-colors" aria-label="Twitter">
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                </a>
                <a [href]="helplineGlobal.social.linkedin" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#12223a] hover:bg-slate-200 transition-colors" aria-label="LinkedIn">
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                </a>
                <a [href]="helplineGlobal.social.instagram" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#12223a] hover:bg-slate-200 transition-colors" aria-label="Instagram">
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
                </a>
              </div>

              <h4 class="text-xs font-bold text-slate-400 mb-2">Helpline Contacts</h4>
              <div class="space-y-1.5 text-xs text-slate-300">
                <div class="flex items-center justify-center md:justify-end gap-2">
                  ...
                  <span>{{ helplineGlobal.contacts.phone }}</span>
                </div>
                <div class="flex items-center justify-center md:justify-end gap-2">
                  <svg class="w-3.5 h-3.5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>{{ helplineGlobal.contacts.email }}</span>
                </div>
              </div>
            </div>
          </div>
